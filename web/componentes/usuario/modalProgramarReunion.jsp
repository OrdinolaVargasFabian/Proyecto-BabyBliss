                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-RRemota" role="tabpanel" aria-labelledby="pills-RRemota-tab" tabindex="0">
                            <form action="" method="post" onsubmit="return false">
                                ...
                                <p class="text-danger">La reunion remota se llevara a cabo mediante la plataforma de videollamadas Zoom, se le otorgará el link de invitación despues de concluir la programacion.</p>
